...
export const columns: ColumnDef<ExtendedSupplier>[] = [
    {
    ...
    },
    {
        ...
        cell: ({ row }) => (
            row.original.phone ? (
                <a href={`https://wa.me/${row.original.phone}`} target='blank' rel="noopener" onClick={(e) => e.stopPropagation()}>
                    {row.original.phone}
                </a>
            ) : null
        )
...
export default function SuppliersList({ suppliers }: { suppliers: ExtendedSupplier[] }) {
                            ...
                            {table.getRowModel().rows?.length ? (
                                table.getRowModel().rows.map((row) => (
                                    <TableRow
                                        ...
                                        key={row.id}
                                        onClick={() => {
                                            router.get(`/suppliers/${row.original.supplier_id}`)
                                        }}
                                    >
